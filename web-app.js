...
import campaign from "./web-page-campaign.js";
...
const routes={home:dashboard,profile,invite,convert,onchain,wallet,task,leaderboard,promo,withdrawal,history,support,watchads,admin,campaign};
