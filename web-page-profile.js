import{api}from"./web-api.js";import{getUser,getDisplayName,haptic,notify}from"./web-telegram.js";import{esc,avatarHTML,fail}from"./web-utils.js";import{bottom}from"./web-page-dashboard.js";import{pinSheet,biometricManager,bmInit,bmRequest,bmAuth}from"./web-security.js";import{onActivity}from"./web-live.js";
export default{async render(el,{go}){const me=await api.getMe(),u=getUser(),name=getDisplayName();let sec={has_pin:false,has_biometric:false};try{sec=await api.getSecurity();}catch(e){fail(e);}
 ...
 // Stats (Total Earned, Tasks Completed) refresh instantly after watching an ad,
 // completing a task, redeeming a promo code, or converting.
 onActivity(()=>{if(!el.querySelector(".security-sheet"))this.render(el,{go});});
}};
